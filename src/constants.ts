...
export const EXAMS_DATA: Record<string, Exam> = {
  ...
  fe: { name: "基本情報技術者試験", hours: 300, type: "anytime", resultDays: 30, resultType: 'next_mid', certDays: 60, isIpa: true, officialUrl: "https://www.ipa.go.jp/shiken/index.html", note: "学習目安: 約200〜400時間" },
